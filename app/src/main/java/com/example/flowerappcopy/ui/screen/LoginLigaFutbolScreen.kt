...
@Composable
fun LoginLigaFutbolScreen(openDashboard: () -> Unit) {
    Log.d("begin", "Login Screen")
                ...
                ConstraintLayout {
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            val loginText = "Ingreso a su cuenta"
                            val loginWord = "Ingreso"
                            ...
                            Row(
                                ...
                                Text(
                                    ...
                                    textAlign = TextAlign.Center,
                                    style = MaterialTheme.typography.subtitle2.copy(color = colorPrimary2)
                                )
                            }
                            ...
                            Button(
                                ...
                                colors = ButtonDefaults.buttonColors(backgroundColor = colorPrimary2)
                            ) {
                                Text(
                            ...
                            val signInText = "No tiene una cuenta? Registrese"
                            val signInWord = "Registrese"
                            ...
                            Text(
                                modifier = Modifier
                                    ...
                                    .clickable {
                                        Toast
                                            .makeText(context, "Registrarse", Toast.LENGTH_SHORT)
                                            .show()
                                    },
...
fun HeaderViewLiga() {
    Image(
        modifier = Modifier
            .fillMaxSize(),
        bitmap = ImageBitmap.imageResource(id = R.drawable.fondologuinligafutbolelqui),
...
@Composable
fun DefaultLigaPreview() {
    LoginLigaFutbolScreen(openDashboard = {})
}